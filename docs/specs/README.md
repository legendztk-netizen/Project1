...
| 6     | Shipment and Customer Order Progress                      | [#8](https://github.com/legendztk-netizen/Project1/issues/8)   | Ready             | #6 completed          |
...
Spec 6 has an [English ticket review draft](../tickets/spec-006-ticket-review.md).
Review approval and ticket publication are separate from implementation approval.
