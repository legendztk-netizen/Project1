...
export function CatalogCommercialMaintenance({
  ...
  commandId?: string;
  seriesPayload?: CatalogItemPayload | null;
  skuPayload?: CatalogItemPayload | null;
  canEdit?: boolean;
  itemMode?: boolean;
          ...
          <Form method="post" noValidate>
            ...
            <fieldset className="commercial-fields" disabled={!canEdit}>
              ...
              <label>
                ...
                <input
                  defaultValue={optionalValue(rule?.hsCode)}
                  name="hsCode"
                />
              </label>
              <label>
          ...
          <Form method="post" noValidate>
            ...
            <fieldset className="commercial-fields" disabled={!canEdit}>
              ...
              <label>
                ...
                <select
                  name="currency"
                  defaultValue={exact?.currency ?? "USD"}
                  onChange={(e) => {
                ...
                >
                  {(itemMode ? itemCurrencies : ["USD"]).map((c) => (
              ...
              <label>
                ...
                <input
                  ...
                  min="0"
                  disabled={itemMode && skuRecord.productType !== "hose"}
